...
model = MLPRegressor(hidden_layer_sizes=(85), activation='relu', solver='adam', batch_size='auto',
                     learning_rate='constant', learning_rate_init=0.05, power_t=0.5,
                     alpha=0.002, random_state=42, max_iter=300)
...
shap.dependence_plot("ta", shap_values, X, interaction_index='tw')

shap.dependence_plot("tc", shap_values, X, interaction_index='b')

shap.dependence_plot("h", shap_values, X, interaction_index='Wr')

shap.dependence_plot("Ec", shap_values, X, interaction_index='a')

shap.dependence_plot("d", shap_values, X, interaction_index='td')

shap.dependence_plot("a", shap_values, X, interaction_index='b')
